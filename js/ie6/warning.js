...
var msg2 = "เพื่อประสบการที่ดีที่สุดในการใช้งานเว็บไซต์ของเรา เราขอแนะนำให้คุณปรับมันเป็นรุ่นใหม่ หรือเปลี่ยนไปใช้เบราวเซอร์ตัวอื่น ด้านล่างคือเว็บเบราวเซอร์จำนวนหนึ่งที่ได้รับความนิยมมากที่สุด";
...
_close.appendChild(document.createTextNode('ปิด'));
...
_close.style.top = '5px';
_close.style.right = '5px';
